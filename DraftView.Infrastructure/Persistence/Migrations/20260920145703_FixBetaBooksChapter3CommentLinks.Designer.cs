...
namespace DraftView.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920145703_FixBetaBooksChapter3CommentLinks")]
    partial class FixBetaBooksChapter3CommentLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.AccessRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("SeenByReaderAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.ReadEvent", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastMarkedReadAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.ReaderMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReaderMessages", (string)null);
                });

            modelBuilder.Entity("DraftView.Domain.Entities.ReaderSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.UserPreferences", b =>
                {
                    ...
                    b.Property<int>("DiffCooldownHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(24);
                    ...
                    b.Property<bool>("NotifyAuthorOnCommentActivity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<string>("ReaderBio")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");

                    b.Property<string>("ReaderGenreInterests")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("ReaderPace")
                        .HasColumnType("text");

                    b.Property<int>("ReaderReturnThresholdDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7);

                    b.Property<string>("ReadingStyle")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("StoryReader");

                    b.Property<bool>("ShowDiffOnRevisit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("ShowEdits")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.Tenancy", b =>
                {
                    b.HasOne("DraftView.Domain.Entities.Account", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DraftView.Domain.Entities.TenancyMembership", b =>
                {
                    ...
                    b.HasOne("DraftView.Domain.Entities.Tenancy", null)
                        .WithMany()
