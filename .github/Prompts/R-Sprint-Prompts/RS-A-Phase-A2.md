...
3. Create `RS-A-base/phase-a2-domain-definition` from `RS-A-base`.
4. All work for this phase must be committed on `RS-A-base/phase-a2-domain-definition`.
5. Developer merges: `RS-A-base/phase-a2-domain-definition` -> `RS-A-base` -> `main`.
