---
mode: agent
description: S-Sprint-8 Phase 3 - Cursor health and abandoned lease cleanup
---

# S-Sprint-8 Phase 3 - Cursor health and abandoned lease cleanup
...
**Phase Brief:** Add detection and recovery for missing/expired Dropbox cursors (trigger full rescan) and abandoned leases (clear lease, mark for retry if stale).

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-8 Phase 3 section
...
### Phase Goal
Add detection and recovery for missing/expired Dropbox cursors (trigger full rescan) and abandoned leases (clear lease, mark for retry if stale).

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-8 Phase 3 for:
...
- [ ] S-Sprint-8 Phase 3 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-8 Phase 3 complete in TASKS.md`
