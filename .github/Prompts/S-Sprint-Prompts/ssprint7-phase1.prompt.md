...
2. Create `ssprint/S-Sprint-7-Phase-1-daily-stale-reconciliation` from `main`
3. All work on `ssprint/S-Sprint-7-Phase-1-daily-stale-reconciliation`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-7-Phase-1-daily-stale-reconciliation` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-7-Phase-1-daily-stale-reconciliation` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-7-Phase-1-daily-stale-reconciliation
