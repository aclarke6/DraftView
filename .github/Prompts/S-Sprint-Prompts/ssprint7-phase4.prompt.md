...
3. Create `S-Sprint-7-base/phase-4-browser-and-operational-verification` from `S-Sprint-7-base`
4. All work on `S-Sprint-7-base/phase-4-browser-and-operational-verification`
5. Developer merges: `S-Sprint-7-base/phase-4-browser-and-operational-verification` -> `S-Sprint-7-base` -> `main`
...
- [ ] Committed to `S-Sprint-7-base/phase-4-browser-and-operational-verification` with message:
...
- [ ] Present for manual execution - do not execute:
  ...
  git merge S-Sprint-7-base/phase-4-browser-and-operational-verification
  git checkout main
