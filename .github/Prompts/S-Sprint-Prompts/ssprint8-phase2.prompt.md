...
# S-Sprint-8 Phase 2 - Stale project reconciliation with lease-based protection
...
**Phase Brief:** Implement stale project detection (no successful sync in 24+ hours), lease acquisition with 30-minute timeout, cursor-based sync attempt, and escalation to full rescan on cursor expiry.

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-8 Phase 2 section
...
### Phase Goal
Implement stale project detection (no successful sync in 24+ hours), lease acquisition with 30-minute timeout, cursor-based sync attempt, and escalation to full rescan on cursor expiry.

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-8 Phase 2 for:
...
- [ ] S-Sprint-8 Phase 2 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-8 Phase 2 complete in TASKS.md`
