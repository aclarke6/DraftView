...
3. Create `S-Sprint-6-base/phase-1-worker-host-and-scheduling` from `S-Sprint-6-base`
4. All work on `S-Sprint-6-base/phase-1-worker-host-and-scheduling`
5. Developer merges: `S-Sprint-6-base/phase-1-worker-host-and-scheduling` -> `S-Sprint-6-base` -> `main`
...
- [ ] Committed to `S-Sprint-6-base/phase-1-worker-host-and-scheduling` with message:
...
- [ ] Present for manual execution - do not execute:
  ...
  git merge S-Sprint-6-base/phase-1-worker-host-and-scheduling
  git checkout main
