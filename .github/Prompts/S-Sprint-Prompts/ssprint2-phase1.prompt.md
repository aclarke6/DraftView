...
2. Create `ssprint/S-Sprint-2-Phase-1-webhook-endpoint-surface` from `main`
3. All work on `ssprint/S-Sprint-2-Phase-1-webhook-endpoint-surface`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-2-Phase-1-webhook-endpoint-surface` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-2-Phase-1-webhook-endpoint-surface` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-2-Phase-1-webhook-endpoint-surface
