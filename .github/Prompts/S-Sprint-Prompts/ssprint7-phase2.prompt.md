...
---
mode: agent
description: S-Sprint-7 Phase 2 - Diagnostics and audit logging
---

# S-Sprint-7 Phase 2 - Diagnostics and audit logging

## Branching
1. Checkout `main` and pull latest from `origin/main`
2. Create `S-Sprint-7-base` from `main` if it does not already exist
3. Create `S-Sprint-7-base/phase-2-diagnostics-and-audit-logging` from `S-Sprint-7-base`
4. All work on `S-Sprint-7-base/phase-2-diagnostics-and-audit-logging`
5. Developer merges: `S-Sprint-7-base/phase-2-diagnostics-and-audit-logging` -> `S-Sprint-7-base` -> `main`

## Context
This is Phase 2 of S-Sprint-7 (Stale Reconciliation and Operational Hardening).

See `DropBox Synchronisation Using WebHooks.md` section for S-Sprint-7 for full phase architecture.

**Phase Brief:** Add structured logging and diagnostic state for webhook receipt, request creation, hold refusal, lease acquisition, sync execution, and failure outcomes.

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-7 Phase 2 section
...
### Phase Goal
Add structured logging and diagnostic state for webhook receipt, request creation, hold refusal, lease acquisition, sync execution, and failure outcomes.

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-7 Phase 2 for:
...
- [ ] Committed to `S-Sprint-7-base/phase-2-diagnostics-and-audit-logging` with message:
    `feat: S-Sprint-7 Phase 2 - Diagnostics and audit logging`
- [ ] `git status` is clean

**Gate 6 - TASKS.md updated**
- [ ] S-Sprint-7 Phase 2 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-7 Phase 2 complete in TASKS.md`

**Gate 7 - Present merge commands**
- [ ] Present for manual execution - do not execute:
  ```
  git checkout S-Sprint-7-base
  git merge S-Sprint-7-base/phase-2-diagnostics-and-audit-logging
  git checkout main
