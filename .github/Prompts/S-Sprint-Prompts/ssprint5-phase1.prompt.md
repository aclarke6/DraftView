...
2. Create `ssprint/S-Sprint-5-Phase-1-existing-pipeline-integration-seam` from `main`
3. All work on `ssprint/S-Sprint-5-Phase-1-existing-pipeline-integration-seam`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-5-Phase-1-existing-pipeline-integration-seam` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-5-Phase-1-existing-pipeline-integration-seam` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-5-Phase-1-existing-pipeline-integration-seam
