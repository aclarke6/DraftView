...
---
mode: agent
description: S-Sprint-3 Phase 4 - Orchestration tests
---

# S-Sprint-3 Phase 4 - Orchestration tests

## Branching
1. Checkout `main` and pull latest from `origin/main`
2. Create `S-Sprint-3-base` from `main` if it does not already exist
3. Create `S-Sprint-3-base/phase-4-orchestration-tests` from `S-Sprint-3-base`
4. All work on `S-Sprint-3-base/phase-4-orchestration-tests`
5. Developer merges: `S-Sprint-3-base/phase-4-orchestration-tests` -> `S-Sprint-3-base` -> `main`

## Context
This is Phase 4 of S-Sprint-3 (Immediate Orchestration Path).

See `DropBox Synchronisation Using WebHooks.md` section for S-Sprint-3 for full phase architecture.

**Phase Brief:** Add tests proving that duplicate requests collapse safely, held projects are deferred, leased projects are skipped, and eligible projects proceed.

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-3 Phase 4 section
...
### Phase Goal
Add tests proving that duplicate requests collapse safely, held projects are deferred, leased projects are skipped, and eligible projects proceed.

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-3 Phase 4 for:
...
- [ ] Committed to `S-Sprint-3-base/phase-4-orchestration-tests` with message:
    `feat: S-Sprint-3 Phase 4 - Orchestration tests`
- [ ] `git status` is clean

**Gate 6 - TASKS.md updated**
- [ ] S-Sprint-3 Phase 4 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-3 Phase 4 complete in TASKS.md`

**Gate 7 - Present merge commands**
- [ ] Present for manual execution - do not execute:
  ```
  git checkout S-Sprint-3-base
  git merge S-Sprint-3-base/phase-4-orchestration-tests
  git checkout main
