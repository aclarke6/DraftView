...
2. Create `ssprint/S-Sprint-3-Phase-4-orchestration-tests` from `main`
3. All work on `ssprint/S-Sprint-3-Phase-4-orchestration-tests`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-3-Phase-4-orchestration-tests` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-3-Phase-4-orchestration-tests` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-3-Phase-4-orchestration-tests
