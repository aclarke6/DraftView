...
2. Create `ssprint/S-Sprint-3-Phase-3-background-sync-orchestration-service-shell` from `main`
3. All work on `ssprint/S-Sprint-3-Phase-3-background-sync-orchestration-service-shell`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-3-Phase-3-background-sync-orchestration-service-shell` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-3-Phase-3-background-sync-orchestration-service-shell` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-3-Phase-3-background-sync-orchestration-service-shell
