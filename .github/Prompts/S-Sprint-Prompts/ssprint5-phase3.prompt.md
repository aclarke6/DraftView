...
2. Create `ssprint/S-Sprint-5-Phase-3-failure-and-recovery-handling` from `main`
3. All work on `ssprint/S-Sprint-5-Phase-3-failure-and-recovery-handling`
4. When all Success Gates pass, present merge commands - do not execute
5. Developer merges: `ssprint/S-Sprint-5-Phase-3-failure-and-recovery-handling` â†’ `main`
...
- [ ] Committed to `ssprint/S-Sprint-5-Phase-3-failure-and-recovery-handling` with message:
...
- [ ] Present for manual execution - do not execute:
  ```
  git checkout main
  git merge ssprint/S-Sprint-5-Phase-3-failure-and-recovery-handling
