...
3. Create `S-Sprint-6-base/phase-2-batch-selection-and-bounded-processing` from `S-Sprint-6-base`
4. All work on `S-Sprint-6-base/phase-2-batch-selection-and-bounded-processing`
5. Developer merges: `S-Sprint-6-base/phase-2-batch-selection-and-bounded-processing` -> `S-Sprint-6-base` -> `main`
...
- [ ] Committed to `S-Sprint-6-base/phase-2-batch-selection-and-bounded-processing` with message:
...
- [ ] Present for manual execution - do not execute:
  ...
  git merge S-Sprint-6-base/phase-2-batch-selection-and-bounded-processing
  git checkout main
