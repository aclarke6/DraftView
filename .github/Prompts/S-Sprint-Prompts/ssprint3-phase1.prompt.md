---
mode: agent
description: S-Sprint-3 Phase 1 - Sync lease service
---

# S-Sprint-3 Phase 1 - Sync lease service
...
5. Developer merges: `ssprint/S-Sprint-3-Phase-1-sync-lease-service` â†’ `main`
...
**Phase Brief:** Create the service that acquires, verifies, and releases a project sync lease with expiry support.

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-3 Phase 1 section
...
### Phase Goal
Create the service that acquires, verifies, and releases a project sync lease with expiry support.

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-3 Phase 1 for:
...
- [ ] S-Sprint-3 Phase 1 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-3 Phase 1 complete in TASKS.md`
