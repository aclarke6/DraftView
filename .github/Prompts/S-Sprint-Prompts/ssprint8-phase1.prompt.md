...
---
mode: agent
description: S-Sprint-8 Phase 1 - Separate console app scaffolding
---

# S-Sprint-8 Phase 1 - Separate console app scaffolding

## Branching
1. Checkout `main` and pull latest from `origin/main`
2. Create `S-Sprint-8-base` from `main` if it does not already exist
3. Create `S-Sprint-8-base/phase-1-separate-console-app-scaffolding` from `S-Sprint-8-base`
4. All work on `S-Sprint-8-base/phase-1-separate-console-app-scaffolding`
5. Developer merges: `S-Sprint-8-base/phase-1-separate-console-app-scaffolding` -> `S-Sprint-8-base` -> `main`

## Context
This is Phase 1 of S-Sprint-8 (Daily Health Check and Reconciliation App).

See `DropBox Synchronisation Using WebHooks.md` section for S-Sprint-8 for full phase architecture.

**Phase Brief:** Create DraftView.HealthCheck console project with DI setup (DbContext, repositories, services), logging configuration, and deployment scripts (systemd service or Task Scheduler config).

## Reading List
Read the following files in order before writing code:

1. `DropBox Synchronisation Using WebHooks.md`
   - Read S-Sprint-8 Phase 1 section
...
### Phase Goal
Create DraftView.HealthCheck console project with DI setup (DbContext, repositories, services), logging configuration, and deployment scripts (systemd service or Task Scheduler config).

### Key Deliverables
Refer to `DropBox Synchronisation Using WebHooks.md` S-Sprint-8 Phase 1 for:
...
- [ ] Committed to `S-Sprint-8-base/phase-1-separate-console-app-scaffolding` with message:
    `feat: S-Sprint-8 Phase 1 - Separate console app scaffolding`
- [ ] `git status` is clean

**Gate 6 - TASKS.md updated**
- [ ] S-Sprint-8 Phase 1 marked complete in TASKS.md
- [ ] Committed with message: `chore: mark S-Sprint-8 Phase 1 complete in TASKS.md`

**Gate 7 - Present merge commands**
- [ ] Present for manual execution - do not execute:
  ```
  git checkout S-Sprint-8-base
  git merge S-Sprint-8-base/phase-1-separate-console-app-scaffolding
  git checkout main
